	...
	<form style="margin-top:15px;">
		<div class="control-group">
			...
			<div class="btn-group" data-toggle="buttons-radio">
				<button type="button" class="btn type {{#if room}} active {{/if}}" data-type="room"><img src="img/room-icon.png" width="24px"  />Room</button>
				<button type="button" class="btn type {{#if apartment}} active {{/if}}" data-type="apartment"><img src="img/apartment-icon.png" width="24px"  />Apartment</button>
				<button type="button" class="btn type {{#if house}} active {{/if}}" data-type="house"><img src="img/house-icon.png" width="24px"  />House</button>
			</div>
		</div>
		<div class="control-group">
